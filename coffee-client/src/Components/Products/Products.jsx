    ...
    return (
        <div className='py-12'>
            <div className='flex flex-col items-center justify-center space-y-4'>
                <h5 className='text-[#1B1A1A] text-lg'>--Sip & Savor--</h5>
                <h1 className='text-[#331A15] text-4xl' style={{ textShadow: '2px 2px 4px rgba(0, 0, 0, 0.9)' }}>
                    Our Popular Products
                </h1>
                <Link to={"/addCoffee"}>
                    <button className='text-[#242222] flex items-center gap-2 bg-[#E3B577] px-6 py-2 text-lg border-2 border-[#242222] rounded-lg'>
                        <p>Add Cofee</p>
